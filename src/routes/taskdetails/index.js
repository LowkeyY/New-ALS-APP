...
function TaskDetails ({ location, dispatch, taskdetails, app }) {
  const { name = '' } = location.query,
    { chartArr, val, isDisabled, taskInfo, taskTitle, localArr, imageArr, workId, flowState, flowLeve, flowId, taskId, isShowButton, isOpen, viewImageIndex, taskType, taskUrgency, creatDate, endDate, complete, isWork, isUpTable, qingshi, integralLargeClassName, integralClassName, integralClass, integralLargeClass } = taskdetails,
    { isSuccess } = chartArr,
